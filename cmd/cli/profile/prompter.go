...
// Implements mock.ProfileFetcher interface.
type Prompter struct {
	reader io.Reader
	writer io.Writer
}

// NewPrompter creates a new profile prompter.
...
// FetchProfile prompts the user for profile information.
// Display name is required (re-prompts if empty).
// Picture URL and status message are optional.
func (p *Prompter) FetchProfile(ctx context.Context, userID string) (*lineclient.UserProfile, error) {
