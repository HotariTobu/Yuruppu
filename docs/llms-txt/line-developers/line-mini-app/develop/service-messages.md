...
Templates are provided by category and you can find them in the [LINE Developers Console](https://developers.line.biz/console/). You can also send a test message to your LINE account to check a preview of the service message. To add a service message template, follow the steps:
