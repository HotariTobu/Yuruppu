...
LINE Developers Console is a tool for developing and testing your LINE MINI App, as well as for submitting LINE MINI Apps for the verification review to make them verified MINI Apps. Currently, LINE Developers Console for LINE MINI App can be used by anyone who is permitted customers in the [LINE MINI App Policy](https://terms2.line.me/LINE_MINI_App?lang=en) if your service area is Japan. If your service area is Taiwan or Thailand, only those who have been approved by our local subsidiary can use the console.
